# -*- encoding: utf-8 -*-
# stub: nokogiri 1.6.7.2.20160920003458 ruby lib
# stub: ext/nokogiri/extconf.rb

Gem::Specification.new do |s|
  s.name = "nokogiri"
  s.version = "1.6.7.2.20160920003458"
